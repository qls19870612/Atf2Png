package  com.loaders
{
	import com.loaders.events.SWFExplorerErrorEvent;
   ...
   */
	 ...
	 *
	 */
	public final class SWFExplorer extends ResLoader
	{
		...
		public function SWFExplorer(url:String="")
		{
...
//			addEventListener(Event.COMPLETE, complete);
		...
		override protected function onLoadedFun(event:Event):void
		{
			try
			{
				var t:uint=getTimer();
				parse(data);
				trace(getTimer() - t, "getTimer()-t->SWFExplorer.onLoadedFun()");
